...
import info from '@/view/data/info.js';
import posting from '@/view/data/posting_list.js';
import project from '@/view/data/project_list.js';
import skills from '@/view/data/skils.js'
import storage from '@/view/data/storage.js'
